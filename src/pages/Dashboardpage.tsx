...
export default function Dashboardpage() {
  ...
  return (
    <>
      <div className="w-full h-full bg-gray-200 font-kumbh">
        <div className="flex flex-no-wrap">
          {/* Sidebar starts */}
          <div className="absolute lg:relative w-64 shadow bg-white hidden lg:block">
            <div className="h-16 w-full flex items-center px-8">
              <img src={logo} alt="" />
            </div>
            <ul aria-orientation="vertical" className=" py-6">
              <li className="pl-6 cursor-pointer text-lg leading-3 tracking-normal pb-4 pt-5 text-gray-600 focus:text-gray-600 focus:outline-none font-bold hover:bg-[#E7E9F9] hover:text-primarygreen">
              ...
              <li className="pl-6 cursor-pointer text-lg leading-3 tracking-normal pb-4 pt-5 text-gray-600 focus:text-gray-600 focus:outline-none font-bold hover:bg-[#E7E9F9] hover:text-primarygreen">
                <div className="flex items-center">
                  ...
                  <span className="ml-2">Church Groups</span>
                </div>
              </li>
              <li className="pl-6 cursor-pointer text-lg leading-3 tracking-normal pb-4 pt-5 text-gray-600 focus:text-gray-600 focus:outline-none font-bold hover:bg-[#E7E9F9] hover:text-primarygreen">
                <div className="flex items-center">
                ...
                <div className="w-full">
                  <div className="border-t border-gray-300">
                    <div className="w-full flex items-center justify-between px-6 pt-1">
                      <div className="flex items-center">
                        <img src={logo} alt="" className="w-8 h-8 rounded-md" />
          ...
          <div className="w-full">
                ...
                <div className="w-1/2 hidden lg:flex">
                  <div className="w-full flex items-center pl-8 justify-end">
                    ...
                    >
                      ...
                      <p className="text-gray-800 text-sm mx-3">Micheal Krapf</p>
            ...
            <div className="container mx-auto py-2 w-[100%] px-2">
